...
export type TerminalThemeId = 'default' | 'dracula' | 'tokyoNight' | 'nord' | 'oneDarkPro' | 'catppuccinMocha' | 'monokaiPro' | 'solarizedDark' | 'everforestDark' | 'rosePine' | 'adventureTime' | 'afterglow' | 'alienBlood' | 'argonaut' | 'bounds' | 'cyberpunk' | 'pixel' | 'zangqing' | 'githubLight' | 'solarizedLight' | 'taxuexunmei' | 'rosePineDown' | 'catppuccinLatte';
